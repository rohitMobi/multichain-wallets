...
var editor = renderer.create('<div className="note-editor note-frame panel panel-default"></div>');
var toolbar = renderer.create('<div className="panel-heading note-toolbar" role="toolbar"></div>');
...
var dropdown = renderer.create('<ul className="note-dropdown-menu dropdown-menu"></ul>', function ($node, options) {
...
var dropdownCheck = renderer.create('<ul className="note-dropdown-menu dropdown-menu note-check"></ul>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
...
var summernote_bs3_checkbox = renderer.create('<div className="checkbox"></div>', function ($node, options) {
...
var ui = function ui(editorOptions) {
  return {
    ...
    button: function button($node, options) {
      return renderer.create('<button type="button" className="note-btn btn btn-default btn-sm" tabindex="-1"></button>', function ($node, options) {
