...
var Dropzone = /*#__PURE__*/function () {
  function Dropzone(context) {
    ...
    this.$dropzone = external_jQuery_default()(['<div className="note-dropzone">', '<div className="note-dropzone-message"></div>', '</div>'].join('')).prependTo(this.$editor);
  }
  /**
...
var Placeholder = /*#__PURE__*/function () {
  ...
  Placeholder_createClass(Placeholder, [{
    ...
    value: function initialize() {
      ...
      this.$placeholder = external_jQuery_default()('<div className="note-placeholder"></div>');
    ...
    value: function colorPalette(className, tooltip, backColor, foreColor) {
      ...
      return this.ui.buttonGroup({
        ...
        children: [this.button({
          ...
          items: (backColor ? ['<div className="note-palette">', '<div className="note-palette-title">' + this.lang.color.background + '</div>', '<div>', '<button type="button" className="note-color-reset btn btn-light btn-default" data-event="backColor" data-value="transparent">', this.lang.color.transparent, '</button>', '</div>', '<div className="note-holder" data-event="backColor"><!-- back colors --></div>', '<div>', '<button type="button" className="note-color-select btn btn-light btn-default" data-event="openPalette" data-value="backColorPicker-' + this.options.id + '">', this.lang.color.cpSelect, '</button>', '<input type="color" id="backColorPicker-' + this.options.id + '" className="note-btn note-color-select-btn" value="' + this.options.colorButton.backColor + '" data-event="backColorPalette-' + this.options.id + '">', '</div>', '<div className="note-holder-custom" id="backColorPalette-' + this.options.id + '" data-event="backColor"></div>', '</div>'].join('') : '') + (foreColor ? ['<div className="note-palette">', '<div className="note-palette-title">' + this.lang.color.foreground + '</div>', '<div>', '<button type="button" className="note-color-reset btn btn-light btn-default" data-event="removeFormat" data-value="foreColor">', this.lang.color.resetToDefault, '</button>', '</div>', '<div className="note-holder" data-event="foreColor"><!-- fore colors --></div>', '<div>', '<button type="button" className="note-color-select btn btn-light btn-default" data-event="openPalette" data-value="foreColorPicker-' + this.options.id + '">', this.lang.color.cpSelect, '</button>', '<input type="color" id="foreColorPicker-' + this.options.id + '" className="note-btn note-color-select-btn" value="' + this.options.colorButton.foreColor + '" data-event="foreColorPalette-' + this.options.id + '">', '</div>', // Fix missing Div, Commented to find easily if it's wrong
          '<div className="note-holder-custom" id="foreColorPalette-' + this.options.id + '" data-event="foreColor"></div>', '</div>'].join('') : ''),
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function createShortcutList() {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = external_jQuery_default()('<div><div className="help-list-item"></div></div>');
  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function createItemTemplates(hintIdx, items) {
      ...
      /*, idx */
        ...
        var $item = external_jQuery_default()('<div className="note-hint-item"></div>');
    ...
    value: function createGroup(idx, keyword) {
      ...
      var $group = external_jQuery_default()('<div className="note-hint-group note-hint-group-' + idx + '"></div>');
...
var TooltipUI = /*#__PURE__*/function () {
  function TooltipUI($node, options) {
    ...
    this.$tooltip = external_jQuery_default()(['<div className="note-tooltip">', '<div className="note-tooltip-arrow"></div>', '<div className="note-tooltip-content"></div>', '</div>'].join('')); // define event
...
var ModalUI = /*#__PURE__*/function () {
  ...
  /*, options */
    ...
    this.$modal = $node;
    this.$backdrop = external_jQuery_default()('<div className="note-modal-backdrop"></div>');
  }
...
var editor = renderer.create('<div className="note-editor note-frame"></div>');
var toolbar = renderer.create('<div className="note-toolbar" role="toolbar"></div>');
var editingArea = renderer.create('<div className="note-editing-area"></div>');
var codable = renderer.create('<textarea className="note-codable" aria-multiline="true"></textarea>');
var editable = renderer.create('<div className="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>');
var statusbar = renderer.create(['<output className="note-status-output" role="status" aria-live="polite"></output>', '<div className="note-statusbar" role="status">', '<div className="note-resizebar" aria-label="resize">', '<div className="note-icon-bar"></div>', '<div className="note-icon-bar"></div>', '<div className="note-icon-bar"></div>', '</div>', '</div>'].join(''));
var airEditor = renderer.create('<div className="note-editor note-airframe"></div>');
var airEditable = renderer.create(['<div className="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>', '<output className="note-status-output" role="status" aria-live="polite"></output>'].join(''));
var buttonGroup = renderer.create('<div className="note-btn-group"></div>');
var summernote_lite_button = renderer.create('<button type="button" className="note-btn" tabindex="-1"></button>', function ($node, options) {
  // set button type
...
var dropdown = renderer.create('<div className="note-dropdown-menu" role="list"></div>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
    var $temp = external_jQuery_default()('<a className="note-dropdown-item" href="#" data-value="' + value + '" role="listitem" aria-label="' + value + '"></a>');
...
var dropdownCheck = renderer.create('<div className="note-dropdown-menu note-check" role="list"></div>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
    var $temp = external_jQuery_default()('<a className="note-dropdown-item" href="#" data-value="' + value + '" role="listitem" aria-label="' + item + '"></a>');
...
var palette = renderer.create('<div className="note-color-palette"></div>', function ($node, options) {
  var contents = [];
...
var dialog = renderer.create('<div className="note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', function ($node, options) {
  if (options.fade) {
    $node.addClass('fade');
  }
...
var popover = renderer.create(['<div className="note-popover bottom">', '<div className="note-popover-arrow"></div>', '<div className="popover-content note-children-container"></div>', '</div>'].join(''), function ($node, options) {
...
var summernote_lite_checkbox = renderer.create('<div className="checkbox"></div>', function ($node, options) {
