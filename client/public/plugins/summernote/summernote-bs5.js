...
var editor = renderer.create('<div className="note-editor note-frame card"/>');
var toolbar = renderer.create('<div className="note-toolbar card-header" role="toolbar"/>');
var editingArea = renderer.create('<div className="note-editing-area"/>');
var codable = renderer.create('<textarea className="note-codable" aria-multiline="true"/>');
var editable = renderer.create('<div className="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>');
...
var airEditor = renderer.create('<div className="note-editor note-airframe"/>');
...
var buttonGroup = renderer.create('<div className="note-btn-group btn-group">');
var dropdown = renderer.create('<div className="note-dropdown-menu dropdown-menu" role="list">', function ($node, options) {
...
var dropdownCheck = renderer.create('<div className="note-dropdown-menu dropdown-menu note-check" role="list">', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
...
var dialog = renderer.create('<div className="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  if (options.fade) {
    $node.addClass('fade');
  }
  ...
  $node.html(['<div className="modal-dialog">', '<div className="modal-content">', options.title ? '<div className="modal-header">' + '<h4 className="modal-title">' + options.title + '</h4>' + '<button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true"></button>' + '</div>' : '', '<div className="modal-body">' + options.body + '</div>', options.footer ? '<div className="modal-footer">' + options.footer + '</div>' : '', '</div>', '</div>'].join(''));
});
var popover = renderer.create(['<div className="note-popover popover show">', '<div className="popover-arrow"></div>', '<div className="popover-body note-children-container"></div>', '</div>'].join(''), function ($node, options) {
...
var summernote_bs5_checkbox = renderer.create('<div className="form-check"></div>', function ($node, options) {
...
var ui = function ui(editorOptions) {
  return {
    ...
    palette: function palette($node, options) {
      return renderer.create('<div className="note-color-palette"/>', function ($node, options) {
        var contents = [];
    ...
    button: function button($node, options) {
      return renderer.create('<button type="button" className="note-btn btn btn-light btn-sm" tabindex="-1">', function ($node, options) {
