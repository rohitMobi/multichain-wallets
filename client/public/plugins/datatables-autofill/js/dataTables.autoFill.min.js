...
r.defaults,d);this.s={dt:new l.Api(a),namespace:".autoFill"+y++,scroll:{},scrollInterval:null,handle:{height:0,width:0},enabled:!1};this.dom={handle:c('<div className="dt-autofill-handle"/>'),select:{top:c('<div className="dt-autofill-select top"/>'),right:c('<div className="dt-autofill-select right"/>'),bottom:c('<div className="dt-autofill-select bottom"/>'),left:c('<div className="dt-autofill-select left"/>')},background:c('<div className="dt-autofill-background"/>'),list:c('<div className="dt-autofill-list">'+this.s.dt.i18n("autoFill.info",
...
f.push("cancel");c.each(f,function(p,q){n.append(c("<li/>").append('<div className="dt-autofill-question">'+e[q].option(b,a)+"<div>").append(c('<div className="dt-autofill-button">').append(c('<button className="'+r.classes.btn+'">'+b.i18n("autoFill.button","&gt;")+"</button>").on("click",function(){var v=e[q].execute(b,a,c(this).closest("li"));d._update(v,a);d.dom.background.remove();d.dom.list.remove()}))))});this.dom.background.appendTo("body");this.dom.list.appendTo("body");this.dom.list.css("margin-top",
