      ...
      <div className="wrapper">
        <nav className="main-header navbar navbar-expand-md navbar-dark navbar-dark border-0 p-3" style={{ marginLeft: "unset", background: "transparent" }}>
          <div className="container">
            ...
            {
              location.pathname.toString().search("ico") !== 1 ?
                <>
                  ...
                  <div className="collapse navbar-collapse order-3" id="navbarCollapse">
                    <ul className="navbar-nav">
                      ...
                      <li className="nav-item">
                        <Link to="/token-transfer" className={window.location.pathname === "/token-transfer" ? "nav-link link-active" : "nav-link"}>
                          Token Transfer
                        </Link>
                      </li>
                      <li className="nav-item">
                      ...
                      {/* <li className="nav-item">
                    <Link to="/white-paper" className={ window.location.pathname === "/white-paper" ? "nav-link link-active" : "nav-link"}>
                      White Paper
                    </Link>
                  </li> */}
                    </ul>
                ...
                <Link to="/ico/dashboard" className="navbar-brand">
                  <span className="brand-text font-weight-light">Raksha Crypto</span>
                </Link>
                  <div className="collapse navbar-collapse order-3" id="navbarCollapse">
                    <ul className="navbar-nav">
                      <li className="nav-item">
                        <Link to="/ico/white-paper" className={window.location.pathname === "/ico/white-paper" ? "nav-link link-active" : "nav-link"}>
                          White Paper
                        </Link>
                      </li>
                    </ul>
