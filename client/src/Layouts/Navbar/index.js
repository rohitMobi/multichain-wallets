  ...
  return (
    <>
      <div className="wrapper">
        <nav
          className="main-header navbar navbar-expand-md navbar-dark navbar-dark border-0 p-3"
              ...
              <>
                <Link to="/home" className="navbar-brand">
                  <img
                    ...
                    style={{ opacity: "0.8", height: "1.8rem" }}
                  />
                  ...
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                      <Link
                        to="/token-transfer"
                        className={
                          window.location.pathname === "/token-transfer"
                            ? "nav-link link-active"
                            : "nav-link"
                        }
                      >
                  ...
                  <ul className="navbar-nav">
                    <li className="nav-item">
                      <Link
                        to="/ico/white-paper"
                        className={
                          window.location.pathname === "/ico/white-paper"
                            ? "nav-link link-active"
                            : "nav-link"
                        }
                      >
                    ...
                    <li className="nav-item float-end">
                      <Link
                        to="/ico/login"
                        className={
                          window.location.pathname === "/ico/login"
                            ? "nav-link link-active"
                            : "nav-link"
                        }
                      >
